...
if(CMAKE_CROSSCOMPILING)
	# クロスコンパイル時は、ターゲットシステムのELFインタープリターを推定
	if(CMAKE_SYSTEM_PROCESSOR MATCHES "i.86")
		set(ELF_INTERP "/lib/ld-linux.so.2")
	elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "x86_64")
		set(ELF_INTERP "/lib64/ld-linux-x86-64.so.2")
	else()
		set(ELF_INTERP "/lib/ld-linux.so.2")  # fallback
	endif()
	message(STATUS "Cross-compiling: Using target ELF interpreter: ${ELF_INTERP}")
else()
